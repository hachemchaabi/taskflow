...
export function ComboboxItem({
  ...
  return (
    <ComboboxPrimitive.Item
      className={cn(
        "grid min-h-8 in-data-[side=none]:min-w-[calc(var(--anchor-width)+1.25rem)] cursor-pointer grid-cols-[1fr_1rem] items-center gap-2 rounded-lg py-1 ps-2 pe-4 text-base outline-none data-disabled:pointer-events-none data-highlighted:bg-accent data-highlighted:text-accent-foreground data-disabled:opacity-64 sm:min-h-7 sm:text-sm [&_svg:not([class*='size-'])]:size-4.5 sm:[&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className,
      )}
    ...
    >
      ...
      <ComboboxPrimitive.ItemIndicator className="col-start-2 ms-auto">
...
export function ComboboxSeparator({
  ...
  return (
    <ComboboxPrimitive.Separator
      className={cn('-mx-1 my-1 h-px bg-border last:hidden', className)}
...
const ghostChipsClassName =
  'relative -mx-2 inline-flex min-h-8 w-full flex-wrap items-center gap-1 rounded-lg bg-transparent px-2 text-base outline-none transition-colors *:min-h-6 hover:bg-muted focus-within:bg-muted has-disabled:pointer-events-none has-disabled:opacity-64 sm:text-sm sm:*:min-h-5'
