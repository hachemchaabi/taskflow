...
export function PaginationPrevious({
  ...
  return (
    <PaginationLink
      ...
      {...props}
    >
      <Icon name={Icons.navigation.arrowLeft} className="sm:-ms-1" />
...
export function PaginationNext({
  ...
  return (
    ...
    >
      ...
      <Icon name={Icons.navigation.arrowRight} className="sm:-me-1" />
    </PaginationLink>
  )
}
...
export function PaginationEllipsis({
  ...
  return (
    <span
      ...
      {...props}
    >
      <Icon name={Icons.ui.dotsHorizontal} className="size-5 sm:size-4" />
