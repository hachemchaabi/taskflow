...
import { Sheet, SheetDescription, SheetHeader, SheetPopup, SheetTitle } from '@/shared/ui/sheet'
...
export function SidebarTrigger({
  ...
  return (
    <Button
      ...
      {...props}
    >
      <Icon name={Icons.ui.openSidebar} />
...
>(function SidebarMenuButton(
  ...
  const buttonProps = mergeProps<'button'>(defaultProps, props, ref ? { ref } : {})
